...
jQuery(document).ready(function (jQuery) {
    ...
    jQuery(window).scroll(function () {
        ...
        if (jQueryiw < 992) {
            ...
            jQuery('.navbar-wrapper3').css({
                'min-height': 110 - (jQueryscrollTop / 2) + 'px'
            });
        }
        jQuery('#dajy').css({
            'top': ((-jQueryscrollTop / 5) + 0) + 'px'
        });
        //jQuery(".sboxpurple").css({'opacity' : 1-(jQueryscrollTop/300)});
        jQuery(".searchcontainer").css({
            'top': ((-jQueryscrollTop / 5) + jQueryheaderheight) + -90 + 'px'
        });
...
jQuery(window).scroll(function () {
    ...
    if (jQuery(window).scrollTop() != 0) {
        jQuery('.mtnav2').stop().animate({
            top: '0px'
        }, 500);
        jQuery('.logo2').stop().animate({
            width: '50px',
            marginTop: '-13px'
        }, 100);
    } else {
    ...
    if (jQuery(window).scrollTop() < jQueryih) {
        ...
        if (jQuery(window).scrollTop() > jQueryih - 400) {
            jQuery('.navbar-fixed-top2').stop().animate({
                top: '-60px'
            }, 500);
        }
        if (jQuery(window).scrollTop() < jQueryih - 400) {
...
$(document).ready(function () {
    function centerSearch() {
        ...
        $('.searchcontainer').css({
            'opacity': 0,
            'marginTop': $srcValign - 30 + 'px'
        });

        setTimeout(function () {
            $('.searchcontainer').stop().animate({
                'opacity': 1,
                'marginTop': $srcValign + 'px'
            }, 1000);
